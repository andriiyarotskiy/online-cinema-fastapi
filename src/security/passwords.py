...
def hash_password(password: str) -> str:
    ...
    This function takes a plain-text password and returns its Argon2 hash.
    The Argon2 algorithm is used with a specified number of rounds for enhanced security.
